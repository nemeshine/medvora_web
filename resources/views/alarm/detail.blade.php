...
<head>
  ...
  <style>
    body { margin-left: 110px; background-color: #f0f2f5; margin-right: 30px;}
    .card-alarm {
...
<div class="container-fluid mt-5">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('alarm.create', ['id_pasien' => $pasien->id_pasien]) }}" class="btn btn-primary" style="margin-right: 50px;">Tambah Alarm</a>
